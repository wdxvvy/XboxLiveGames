...
(function() {
    "use strict";
    scriptValidator("/Controls/dialog.js", "/Framework/corefx.js");
    WinJS.Namespace.define("MS.Entertainment.UI.Controls", {WebHostDialog: MS.Entertainment.UI.Framework.deriveUserControl(MS.Entertainment.UI.Controls.Dialog, "Controls/WebHostDialog.html#webHostDialogTemplate", function webHostDialogConstructor(element, options) {
            ...
            options.userControlOptions.errorListener = WinJS.Utilities.markSupportedForProcessing(function() {
                if (errorHandler !== undefined)
                    errorHandler();
                that.hide()
            });
            this.keyPressEvent = function(event) {
                if (event.keyCode === WinJS.Utilities.Key.escape || event.keyCode === WinJS.Utilities.Key.dismissButton) {
            ...
            autoSetFocus: true, keyPressEvent: null, initialize: function initialize() {
    ...
    WinJS.Namespace.define("MS.Entertainment.UI.Controls", {ShowWebHostDialogAction: MS.Entertainment.derive(MS.Entertainment.UI.Actions.Action, null, {
