...
(function() {
    "use strict";
    scriptValidator("/Framework/corefx.js", "/Framework/debug.js", "/Framework/Utilities.js", "/Controls/listControls.js", "/Controls/PopOver.js");
    var _viewMoreAlreadyShown = false;
    ...
    WinJS.Namespace.define("MS.Entertainment.UI.Controls", {
        ImmersiveLayout: MS.Entertainment.UI.Framework.deriveUserControl(MS.Entertainment.UI.Controls.ItemsControl, null, function ImmersiveLayout_Constructor(element, options) {
            ...
            columnWidth: 400, bringIntoViewLeftMargin: 120, _backButtonMargin: 40, _calculatedHeroFrameWidth: 0, _backButtonLeftEdge: 120, _currentHeroFrame: null, _boundHandleHeroFrameFullScreenChange: null, currentFrameIndex: MS.Entertainment.UI.Framework.observableProperty("currentFrameIndex", 0), loadItemTemplate: function loadItemTemplate() {
                    this._itemTemplateProvider = {
                        render: function render(context, element) {
                            ...
                            if (context === this._workingDataSource.item(0)) {
                                WinJS.Utilities.addClass(element, "immersiveTwoColumn");
                    ...
                    if (!this._workingDataSource || !this._workingDataSource.length || MS.Entertainment.Utilities.isApp2)
                        return;
                ...
                _viewMoreButton: null, _content: null, _contentControl: null, _viewMoreOpened: false, _overlayResult: null, frame: null, ignoreChildrenInitialization: true, initialize: function initialize() {
                ...
                viewMoreButtonVisible: true, viewMoreClickedHandler: null
                ...
                closeAction: null, dontWaitForContent: true, autoSetFocus: false, initialize: function initialize() {
                        ...
                        if (MS.Entertainment.Utilities.getTextDirection() === MS.Entertainment.Utilities.TextDirections.RightToLeft) {
                            var backEdge = window.outerWidth - position.left;
                            var viewMoreEdge = window.outerWidth - (this.framePosition.left + this.framePosition.width);
                ...
                showPopOver: function showPopOver(data) {
                    if (_viewMoreAlreadyShown)
                        return {completionPromise: WinJS.Promise.as()};
                    _viewMoreAlreadyShown = true;
