...
WinJS.Namespace.define("MS.Entertainment.UI.Controls", {NowPlayingOverlays: MS.Entertainment.UI.Framework.defineUserControl("Controls/NowPlaying/NowPlayingOverlays.html#nowPlayingTemplate", function(element, options){}, {
        autoHidePlaylist: 120000, autoHideVideoOverlays: 3000, positionChangedThreshold: 30000, _uiStateService: MS.Entertainment.ServiceLocator.getService(MS.Entertainment.Services.uiState), _bindings: null, _eventHandlers: null, _keyHandlers: null, _mainHeader: null, _sessionMgr: null, _uiSettings: new Windows.UI.ViewManagement.UISettings, _deferredUpdateTimer: null, _lastMousePos: {
                x: -10, y: -10
            }, _useBranding: false, _freezeDelayPromise: null, _opportunityDelayTimeoutMS: 333, _opportunityTrackEndThresholdMS: 5000, _opportunityHidePromise: null, _engageHideOffsetMS: 500, _showOpportunityOnDismiss: false, _navigationService: null, _playlistOverlay: null, _brandingShowPromise: null, _backButtonServiceInternal: null, _mediaChangedWhileFrozen: false, _seekBarManipulatingChangedBound: null, _playbackSessionChangedBound: null, _overlaysVisible: false, _resizeButtonVisible: false, _seekBarVisible: false, _transportControlsVisible: false, _backButtonService: {get: function backButtonService_get() {
                ...
                if (this.frozen || this._freezeDelayPromise)
                    return;
                if (this.playlistVisible) {
                ...
                else if (event && this._allowedKeys.indexOf(event.keyCode) >= 0)
                    this.showOverlays()
                    ...
                    switch (this.playbackSession.currentTransportState) {
                        ...
                        case MS.Entertainment.Platform.Playback.TransportState.stopped:
                            if (this.playbackSession.playerState === MS.Entertainment.Platform.Playback.PlayerState.error)
                                ...
                                if (this.playbackSession.currentOrdinal !== 0)
                ...
                var initialBind = (oldVal === undefined);
                ...
                else if (!this.frozen && !initialBind)
                    this.showOverlays(true)
                ...
                if (this.playbackSession)
                    ...
                    this.overlaysVisible = (this.playbackSession || this._uiStateService.isSnapped || this._uiStateService.nowPlayingTileVisible);
                    if (!this._uiStateService.isSnapped) {
                        this._updateTransportControlsVisibility(false);
                        if (this._seekBar)
                ...
                var hidePromise = this._useBranding ? WinJS.Promise.timeout(500, MS.Entertainment.Utilities.hideElement(this._brandingContainer)) : WinJS.Promise.wrap();
                ...
                if (!this.playlistVisible) {
                    ...
                    var response = MS.Entertainment.UI.Controls.ImmersiveViewMore.showPopOver({
                            frame: {
                                columnStyle: "immersivePlaylist", heading: String.load(String.id.IDS_HOME_NOW_PLAYING_LC)
                ...
                if (this.frozen || !this.initialized)
                    return;
                if (Math.abs(newVal - oldVal) > this.positionChangedThreshold)
                    this.showOverlays(newVal === 0);
                ...
                WinJS.Utilities.removeClass(this.domElement, "musicOverlay");
                ...
                if (this._uiStateService.nowPlayingTileVisible)
                    this.showOverlays();
                else if (newVal === MS.Entertainment.Platform.Playback.TransportState.starting)
                    this.hideOverlays();
                else if (oldVal)
                    this.showOverlays()
                ...
                this.overlaysVisible = (this._uiStateService.isSnapped || (!this.playlistVisible && this.overlaysVisible) || (this.playbackSession.isRemoteSession()));
                var showHeader = !this._isImmersiveNowPlaying() || (this.backVisible || this.overlaysVisible);
                if (this._mainHeader && (!this.playbackSession || !this._uiStateService.engageVisible))
                ...
                resizeButtonVisible = !this._uiStateService.isFullScreenMusic && !this._uiStateService.isSnapped && !this._uiStateService.nowPlayingTileVisible && this.overlaysVisible && this.transportControlsVisible;
                ...
                if (this.playbackSession.currentMedia && MS.Entertainment.Platform.PlaybackHelpers.isGame(this.playbackSession.currentMedia))
                    resizeButtonVisible = false;
                ...
                this.resizeButtonIcon = this._uiStateService.nowPlayingInset ? MS.Entertainment.UI.Icon.screenFull : MS.Entertainment.UI.Icon.screenNormal;
                ...
                if (!domElement)
                    return;
                if (makeVisible)
                    MS.Entertainment.Utilities.showElement(domElement);
                else
                    MS.Entertainment.Utilities.hideElement(domElement)
            }, overlaysVisible: {
                get: function() {
                    return this._overlaysVisible
                        ...
                        if (this._overlaysVisible !== value) {
                            ...
                            this._updateVisibility(this._nowPlayingOverlayContainer, value)
                        }
                    }
            }, resizeButtonVisible: {
                get: function() {
                    return this._resizeButtonVisible
                        ...
                        if (this._resizeButtonVisible !== value) {
                            ...
                            this._updateVisibility(this._resizeButton, value)
                        }
                    }
            }, seekBarVisible: {
                get: function() {
                    return this._seekBarVisible
                        ...
                        if (this._seekBarVisible !== value) {
                            ...
                            this._updateVisibility(this._seekBar, value)
                        }
                    }
                ...
                get: function() {
                    return this._transportControlsVisible
                        ...
                        if (this._transportControlsVisible !== value) {
                            ...
                            this._updateVisibility(this._transportControls, value)
                        }
                    }
            }
    }, {
