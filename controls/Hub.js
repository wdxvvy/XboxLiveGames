...
scriptValidator("/Framework/corefx.js", "/Framework/utilities.js", "/Animations/HubStripAnimations.js");
            ...
            fragmentUrl: "", initialize: function initialize() {
                    ...
                    if (newValue) {
                        ...
                        if (this.primaryModifierControl && newValue.settingsKey) {
                            this.primaryModifierControl.isRoamingSetting = newValue.isRoamingSetting;
