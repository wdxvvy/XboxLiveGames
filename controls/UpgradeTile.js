...
(function(MS) {
    (function(Entertainment) {
        (function(UI) {
            (function(Controls) {
                var Actions = MS.Entertainment.UI.Actions;
                var UpgradeTile = (function(_super) {
                        ...
                        function UpgradeTile(element, options) {
                            ...
                            if (!this.imageUrl)
                                ...
                                else if (MS.Entertainment.Utilities.isGamesApp)
                                    this.imageUrl = "/images/tiles/XBL_GAMES_150x150_A.png";
                            if (!this.bigMessage)
                        ...
                        UpgradeTile.getUpgradeFeedInformation = function getUpgradeFeedInformation() {
                            var query;
                            if (MS.Entertainment.Utilities.isGamesApp)
                                query = new MS.Entertainment.Data.Query.GamesUpdatePanel;
                            ...
                            return query.execute().then(function upgradePanelSuccess(queryResult) {
                                    if (!queryResult)
                                        return null;
                                    var data = {
                                    ...
                                    return data
                                }, function upgradePanelFailure(e) {
