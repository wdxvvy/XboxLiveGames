...
(function() {
    ...
    WinJS.Namespace.define("MS.Entertainment.ViewModels", {
        BaseHeroViewModel: MS.Entertainment.derive(MS.Entertainment.Utilities.EventInvoker, function baseHeroViewModel(mediaItem) {
            this.base();
            this.mediaItem = mediaItem
        }, {
            mediaItem: null, buttons: null, actionDescription: null, sessionId: null, _addButtons: function _addButtons(buttons) {
                    var buttonKey;
                    if (!this.buttons)
