...
scriptValidator("/Controls/overlay.js", "/Controls/dialog.js", "/Framework/corefx.js", "/Framework/debug.js");
MS.Entertainment.UI.Debug.defineAssert("MS.Entertainment.UI.Shell");
(function() {
    "use strict";
    WinJS.Namespace.define("MS.Entertainment.Shell", {BackButton: WinJS.Class.define(function BackButton() {
            ...
            _initialized: false, _backButton: null, _navigation: null, _navigationWrapped: null, _overrideShowBackButton: false, _overrideBackButtonMode: null, overrideShowBackButton: {
                    get: function() {
                    ...
                    if (this.overrideBackButtonMode)
