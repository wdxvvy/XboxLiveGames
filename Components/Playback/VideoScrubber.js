...
(function() {
    ...
    WinJS.Namespace.defineWithParent(MSEPlatform, "Playback", {VideoScrubber: WinJS.Class.derive(MSEPlatform.Playback.VideoScrubberObservables, function VideoScrubber_constructor(playbackControl) {
            if (!playbackControl)
                return;
